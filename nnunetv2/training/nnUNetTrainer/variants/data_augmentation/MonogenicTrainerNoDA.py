...
from nnunetv2.training.nnUNetTrainer.variants.network_architecture.MonogenicUNetTrainer import MonogenicUNetTrainer

class MonogenicUNetTrainerNoDA(MonogenicUNetTrainer):
    @staticmethod
