...
class UNext(nn.Module):
    ...
    def __init__(self,  num_classes, input_channels=1, deep_supervision=True, img_size=512, patch_size=16,
                 embed_dims=[16, 32, 128, 160, 256], num_heads=[1, 2, 4, 8], mlp_ratios=[4, 4, 4, 4],
        ...
        self.seg2 = nn.Conv2d(embed_dims[2], num_classes, kernel_size=1)
        self.seg3 = nn.Conv2d(embed_dims[1], num_classes, kernel_size=1)
        self.seg4 = nn.Conv2d(embed_dims[0], num_classes, kernel_size=1)
        self.seg5 = nn.Conv2d(embed_dims[0], num_classes, kernel_size=1)
